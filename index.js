const categories = [
    ...
    function clickButton1(){
        let addCartButtonEle1 = document.getElementById("addCartButton1");
        addCartButtonEle1.style.backgroundColor = "#d3d3d3";
    }
    function clickButton2(){
        let addCartButtonEle2 = document.getElementById("addCartButton2");
        addCartButtonEle2.style.backgroundColor = "#d3d3d3";
    }
    function clickButton3(){
        let addCartButtonEle3 = document.getElementById("addCartButton3");
        addCartButtonEle3.style.backgroundColor = "#d3d3d3";
    }
    function clickButton4(){
    let addCartButtonEle = document.getElementById("addCartButton");
    addCartButtonEle.style.backgroundColor = "#d3d3d3";
    }